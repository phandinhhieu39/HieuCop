...
Route::get('category/category_list/{parent_id?}/{status?}',[CategoryController::class,'slider_list']);
Route::get('product/product_list/{limit}/{category_id?}/{status?}',[ProductController::class,'slider_list']);
